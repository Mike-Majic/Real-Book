...
export const CONTENT_INTERACTIONS = [
  ...
  { id: 'int-17', userId: 20, categoryId: 'gaming-pc', contentId: 'pc-2', type: 'mi_piace', timestamp: '2026-09-11T20:00:00Z' },
  { id: 'int-18', userId: 2, categoryId: 'gaming-xbox', contentId: 'xb-3', type: 'mi_piace', timestamp: '2026-09-12T19:30:00Z' },
  { id: 'int-19', userId: 1, categoryId: 'cosplay', contentId: 'cos-2', type: 'mi_piace', timestamp: '2026-09-13T15:10:00Z' },
  { id: 'int-20', userId: 3, categoryId: 'streaming', contentId: 'str-1', type: 'mi_piace', timestamp: '2026-09-10T21:45:00Z' },
  { id: 'int-21', userId: 9, categoryId: 'giochi-tavolo', contentId: 'gdt-5', type: 'parteciperò', timestamp: '2026-09-14T18:20:00Z' },
  { id: 'int-22', userId: 11, categoryId: 'nerd-live', contentId: 'live-n3', type: 'parteciperò', timestamp: '2026-09-13T12:00:00Z' },
  { id: 'int-23', userId: 17, categoryId: 'gaming-ps', contentId: 'ps-4', type: 'mi_piace', timestamp: '2026-09-12T22:15:00Z' },
  { id: 'int-24', userId: 6, categoryId: 'live', contentId: 'live-a1', type: 'parteciperò', timestamp: '2026-09-14T21:00:00Z' },
  { id: 'int-25', userId: 20, categoryId: 'nerd-live', contentId: 'live-n1', type: 'parteciperò', timestamp: '2026-09-09T17:00:00Z' },
  { id: 'int-26', userId: 4, categoryId: 'gaming-pc', contentId: 'pc-1', type: 'mi_piace', timestamp: '2026-09-11T10:30:00Z' },
];
