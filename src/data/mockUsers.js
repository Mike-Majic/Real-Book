...
export const MOCK_USERS = [
  { id: 1, name: 'Giulia', age: 27, gender: 'donna', city: 'Roma', country: 'Italia', lat: 41.9028, lng: 12.4964, avatar: 'https://i.pravatar.cc/150?img=47', worlds: ['social', 'incontri'], bio: 'Fotografa di strada, amo i tramonti su Roma.', artType: 'Arte visiva' },
  ...
  { id: 3, name: 'Sara', age: 24, gender: 'donna', city: 'Milano', country: 'Italia', lat: 45.4642, lng: 9.19, avatar: 'https://i.pravatar.cc/150?img=32', worlds: ['incontri'], bio: 'Studio pianoforte al conservatorio.', artType: 'Musica' },
  ...
  { id: 6, name: 'Davide', age: 26, gender: 'uomo', city: 'Bologna', country: 'Italia', lat: 44.4949, lng: 11.3426, avatar: 'https://i.pravatar.cc/150?img=51', worlds: ['social'], bio: 'Regista amatoriale, cerco attori per cortometraggi.', artType: 'Cinema' },
  ...
  { id: 11, name: 'Manon', age: 25, gender: 'donna', city: 'Parigi', country: 'Francia', lat: 48.8566, lng: 2.3522, avatar: 'https://i.pravatar.cc/150?img=29', worlds: ['social'], bio: 'Danzatrice contemporanea.', artType: 'Teatro / Danza' },
