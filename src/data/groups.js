// Gruppi del mondo Social (Blu) — piccole community tematiche in stile
// "subreddit": chiunque può sfogliarle, iscriversi/disiscriversi richiede
// login (stessa regola di like/commenti). Un post può appartenere a un
// gruppo (gruppo_id) oppure stare nella bacheca generale (gruppo_id: null).
//
// memberCount è un numero di partenza "finto" (nessun backend): serve solo
// a far sembrare i gruppi vivi. Chi si iscrive in questa sessione vede +1
// nel conteggio mostrato, calcolato a runtime — non è persistito qui.
export const GROUPS = [
  {
    id: 'fotografia',
